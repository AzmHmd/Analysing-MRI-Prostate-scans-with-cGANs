...
fichier = open("dwi/compare_final/results.txt","w")
fichier2 = open("dwi/compare_final/results2.txt","w")
...
for a in range (16,26) : 
    ...
    for i in range (1,x2+1):
        ...
        path_mask_raw_denoised = 'dwi/prostate_dwi_raw_denoised_3_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        ...
        cv2.imwrite('dwi/compare_final/'+im+'.png',add)
