...
fichier_dice = open("t2w/compare_final/Dice.txt","w")
fichier_jac = open("t2w/compare_final/Jacard.txt","w")
fichier_haus = open("t2w/compare_final/Hausdorff.txt","w")
fichier_haus95 = open("t2w/compare_final/Hausdorff95.txt","w")
