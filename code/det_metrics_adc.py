...
fichier2 = open("adc/results.txt","w")
...
for a in range (16,26) : 
    ...
    for i in range (1,x2+1):
        ...
        path_mask_raw_noisy = 'adc/prostate_adc_raw_noisy_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_noisy = 'adc/prostate_adc_noisy_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 


        path_mask_noisy2 = 'adc/prostate_adc_noisy2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_raw_noisy2 = 'adc/prostate_adc_raw_noisy2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_noisy3 = 'adc/prostate_adc_noisy3_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_raw_noisy3 = 'adc/prostate_adc_raw_noisy3_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_denoised2 = 'adc/prostate_adc_denoised2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_raw_denoised2 = 'adc/prostate_adc_raw_denoised2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
