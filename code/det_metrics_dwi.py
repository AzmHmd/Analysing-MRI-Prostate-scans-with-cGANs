...
fichier2 = open("dwi/results.txt","w")
...
for a in range (16,26) : 
    ...
    for i in range (1,x2+1):
        ...
        path_raw = 'dwi/prostate_dwi_raw_lr_low/'+nb+'_net_G_val/images/input/r'+im+'.png'
        path_denoised = 'dwi/denoised/val/d'+im+'.png'
        path_noisy = 'dwi/noisy/val/n'+im+'.png'
        path_mask_ori = 'dwi/prostate_dwi_raw_lr_low/'+nb+'_net_G_val/images/target/r'+im+'.png'
        path_mask_raw = 'dwi/prostate_dwi_raw_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_denoised = 'dwi/prostate_dwi_denoised_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_raw_denoised = 'dwi/prostate_dwi_raw_denoised_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_raw_denoised_noisy = 'dwi/prostate_dwi_raw_denoised_noisy_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_raw_noisy = 'dwi/prostate_dwi_raw_noisy_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_noisy = 'dwi/prostate_dwi_noisy_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 

        path_mask_noisy = 'dwi/prostate_dwi_noisy_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_noisy2 = 'dwi/prostate_dwi_noisy2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_raw_noisy2 = 'dwi/prostate_dwi_raw_noisy2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_noisy3 = 'dwi/prostate_dwi_noisy3_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_raw_noisy3 = 'dwi/prostate_dwi_raw_noisy3_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_denoised2 = 'dwi/prostate_dwi_denoised2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
        path_mask_raw_denoised2 = 'dwi/prostate_dwi_raw_denoised2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png' 
