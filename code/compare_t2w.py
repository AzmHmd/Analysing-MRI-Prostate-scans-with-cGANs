...
fichier = open("t2w/compare_final/results.txt","w")
fichier2 = open("t2w/compare_final/results2.txt","w")
...
for a in range (16,26) : 
    ...
    for i in range (1,x2+1):
        ...
        path_mask_denoised = 't2w/prostate_t2w_denoised_2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_raw_denoised = 't2w/prostate_t2w_raw_denoised_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        path_mask_raw_denoised_noisy = 't2w/prostate_t2w_raw_denoised_noisy_2_lr_low/'+nb+'_net_G_val/images/post/r'+im+'.png'
        ...
        cv2.imwrite('t2w/compare_final/'+im+'.png',add)
