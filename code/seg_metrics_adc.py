...
fichier_dice = open("adc/compare_final/Dice.txt","w")
fichier_jac = open("adc/compare_final/Jacard.txt","w")
fichier_haus = open("adc/compare_final/Hausdorff.txt","w")
fichier_haus95 = open("adc/compare_final/Hausdorff95.txt","w")
