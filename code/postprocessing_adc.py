...
for k in range(8,12):
    if k ==0 : 
        fold = 'raw'
        createFolder ('./adc/prostate_adc_'+fold+'_lr_low/'+nb+'_net_G_val/images/post/')
        print(fold)
    if k == 1 : 
        fold = 'noisy'
        createFolder ('./adc/prostate_adc_'+fold+'_lr_low/'+nb+'_net_G_val/images/post/')
    ...
    for a in range (16,26) : 
        ...
        for i in range (1,x2+1):
            ...
            path_raw = 'adc/prostate_adc_'+fold+'_lr_low/'+nb+'_net_G_val/images/input/'+im+'.png'
            path_mask_ori = 'adc/prostate_adc_'+fold+'_lr_low/'+nb+'_net_G_val/images/target/'+im+'.png'
            path_mask_pred = 'adc/prostate_adc_'+fold+'_lr_low/'+nb+'_net_G_val/images/output/'+im+'.png'
            ...
            cv2.imwrite('adc/prostate_adc_'+fold+'_lr_low/'+nb+'_net_G_val/images/post/'+im+'.png',mask_return_gray)
